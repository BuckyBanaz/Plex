          ...
          Positioned.fill(
            child: Obx(() {
              ...
              return GoogleMap(
                ...
                _initialCamera ?? CameraPosition(target: fallbackLatLng, zoom: 13.5),
                markers: markers,
                polylines: polylines,
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              ctrl.order.value?.driverDetails?['name'] ?? 'Driver',
                              style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
                            ),
                            const SizedBox(height: 4),
                            Text(
                              ctrl.order.value?.driverDetails?['vehicle'] ?? '-',
                      ...
                      Row(
                        children: [
                          IconButton(
                            ...
                            icon: const Icon(IconlyBold.call, color: Colors.green),
                          ),
                          IconButton(
                            onPressed: () {
                              // TODO: chat with driver
                            },
                            icon: Icon(IconlyBold.chat, color: AppColors.primary),
                          ),
                        ],
                      ),
                    ],
